...
void        Bureaucrat::incrementGrade() { grade - 1 < 1 ? throw Bureaucrat::GradeTooHighException() : grade -= 1; }
void        Bureaucrat::decrementGrade() { grade + 1 > 150 ? throw Bureaucrat::GradeTooLowException() : grade += 1; }
